...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>public/assets/css/modules/adm/apotek.css">
...
<script type="text/javascript" src="<?=base_url()?>public/assets/js/app/helper.js"></script>
	<script type="text/javascript" src="<?=base_url()?>public/assets/js/modules/adm/laborat.js?<?=md5(microtime())?>"></script>
</head>
<body>

<div class="container-fluid"  id="admLabo">
	...
	<div class="row" style="margin-bottom: 70px;padding-top: 1em">
		...
		<div class="col-md-9 leftPane" id="admLaboTable">
			<div class="row" style="padding-top: 5px">
				<div class="col-md-12" style="">
					<nav>
					<div class="nav nav-tabs" id="nav-tab" role="tablist" style="border-bottom: none;">
						<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-list-tab" data-toggle="tab" href="#nav-list" role="tab" aria-controls="nav-list" aria-selected="true">List Antrian Laborat</a>
		...
		<div class="col-md-3" id="admLaboBox">
			<div class="row" style="padding: 0 15px">
				<div class="col-md-12 kotak-a">
					...
					<p class="text-center" v-text="id_lab!=-1?nama+ '('+alamat+')':'Belum Ada Pasien'"></p>
					...
					<div class="row">
						<div class="col-md-12 text-center mt1em" >
							<button class="btn btn-warning" :disabled="btnApotekState!=1 " @click="executeBtnProc('apotek')"><i class="fas  fa-check"></i> Apotek</button>
						</div>
						<div>&nbsp;</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-md-12 text-center mt1em" >
							<button class="btn btn-warning" :disabled="btnApotekState!=1 " @click="executeBtnProc('register_poli')"><i class="fas  fa-check"></i> Daftarkan</button>
						</div>
						<div>&nbsp;</div>
					</div>
