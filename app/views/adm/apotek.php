...
<script type="text/javascript" src="<?=base_url()?>public/assets/js/app/helper.js"></script>
	<script type="text/javascript" src="<?=base_url()?>public/assets/js/modules/adm/apotek.js?<?=md5(microtime())?>"></script>
</head>
<body>

<div class="container-fluid"  id="admApo">
	...
	<div class="row" style="margin-bottom: 70px;padding-top: 1em">
		...
		<div class="col-md-9 leftPane" id="admApoTable">
			<div class="row" style="padding-top: 5px">
				<div class="col-md-12" style="">
					<nav>
					<div class="nav nav-tabs" id="nav-tab" role="tablist" style="border-bottom: none;">
						<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-list-tab" data-toggle="tab" href="#nav-list" role="tab" aria-controls="nav-list" aria-selected="true">List Antrian Apotek</a>
		...
		<div class="col-md-3" id="admApoBox">
			<div class="row" style="padding: 0 15px">
				<div class="col-md-12 kotak-a">
					...
					<p class="text-center" v-text="id_maa!=-1?nama+ '('+alamat+')':'Belum Ada Pasien'"></p>
					...
					<div class="row"  >
						<div class="col-md-12 text-center mt1em" >
							<button class="btn btn-warning" :disabled="btnFinishState!=1 " @click="executeBtnProc('finish')"><i class="fas  fa-check"></i> Selesai</button>
						</div>
						<div>&nbsp;</div>
					</div>
