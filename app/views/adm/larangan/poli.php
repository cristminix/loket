		...
		<div class="col-md-3" id="admPoliBox">
			<div class="row" style="padding: 0 15px">
				<div class="col-md-12 kotak-a">
					...
					<div class="row" v-if="laborat==0 && nama_poli !='Poli Kesehatan Awal'">
					...
					<div class="row" v-if="laborat==1 && nama_poli !='Poli Kesehatan Awal'" style="padding-bottom: 1em">
					...
					<div class="row" v-if="laborat==0 && nama_poli =='Poli Kesehatan Awal'">
						<div class="col-md-12"><?=$dd_poli2?></div>
						<div class="col-md-12 text-center mt1em" >
							<button class="btn btn-warning" :disabled="btnApotikState!=1 " @click="executeBtnProc('register_poli')"><i class="fas  fa-credit-card"></i> Daftarkan</button>
						</div>
						<div>&nbsp;</div>
					</div>
